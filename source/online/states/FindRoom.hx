...
class FindRoom extends MusicBeatState {
    ...
    override function update(elapsed) {
        ...
        if (FlxG.keys.justPressed.R #if mobileC || virtualPad.buttonC.justPressed #end) {
            refreshRooms();
        }
        ...
        if (controls.BACK #if mobileC || virtualPad.buttonB.justPressed #end) {
...
class RoomText extends FlxText {
    ...
    override function update(elapsed) {
		...
		if (FindRoom.curSelected == ID && (!FlxG.keys.justPressed.R #if mobileC || !MusicBeatState.instance.virtualPad.buttonC.justPressed #end) && (FindRoom.coolControls.ACCEPT  #if mobileC || !MusicBeatState.instance.virtualPad.buttonA.justPressed #end)) {
