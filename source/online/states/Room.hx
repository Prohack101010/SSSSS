...
class Room extends MusicBeatState {
	...
	public function new() {
		...
		roomCodeTip = new FlxText(0, roomCode.y + roomCode.height + 5, FlxG.width, "(Press " #if mobileC + "Z" + #else + "S" + #end " to show your room code, CTRL+C to copy)");
		...
		chatBoxTip = new FlxText(0, 0, 0, "(Press " + #if mobileC "C" #else "TAB" #end + " to show chat)");
		...
		settingsTip = new FlxText(0, 0, 0, "(Press " + #if mobileC "Y" #else "SHIFT" #end + " to open settings)");
